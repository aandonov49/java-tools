...
public class Schedule {
   ...
   * "Descr" is used by two different parts of a schema. See: line 766 of
   * file:/opt/workspace/java-tools/pfsense/src/main/dtd/pfsense.xsd line 761 of
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Timerange } {@link
